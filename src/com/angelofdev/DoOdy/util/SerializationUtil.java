...
/**
 * As soon as we can switch to 1.6.2-R0.2, use
 * BukkitObjectOutputStream/BukkitObjectInputStream instead
 * 
 * @author evilmidget38
 */
@Deprecated
public class SerializationUtil {
	...
	public static ConfigurationSerializable deserialize(Map<String, Object> map) {
		for (Entry<String, Object> entry : map.entrySet()) {
			// Check if any of its sub-maps are ConfigurationSerializable. They
